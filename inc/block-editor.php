...
add_action( 'after_setup_theme', 'mesinhl_block_editor_setup' );

if ( ! function_exists( 'mesinhl_block_editor_setup' ) ) {
	 ...
	 * @since 1.0.0
	 */
	function mesinhl_block_editor_setup() {
		...
		$color_palette = mesinhl_generate_color_palette();
		if ( $color_palette ) {
...
if ( ! function_exists( 'mesinhl_generate_color_palette' ) ) {
	/**
	 ...
	 * @return array
	 */
	function mesinhl_generate_color_palette() {
		$color_palette = array();
		 ...
		 */
		return apply_filters( 'mesinhl_theme_editor_color_palette', $color_palette );
	}
}

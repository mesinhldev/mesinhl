...
if ( ! function_exists( 'mesinhl_theme_slug_sanitize_select' ) ) {
	/**
	 * Sanitize select.
	 *
	 * @deprecated 1.2.0 Use mesinhl_customize_sanitize_select()
	 * @see mesinhl_customize_sanitize_select()
	 *
	 * @since 0.6.11
	 *
	 ...
	 */
	function mesinhl_theme_slug_sanitize_select( $input, $setting ) {
		_deprecated_function( __FUNCTION__, '1.2.0', 'mesinhl_customize_sanitize_select' );
		return mesinhl_customize_sanitize_select( $input, $setting );
	}
}
...
if ( ! function_exists( 'mesinhl_adjust_body_class' ) ) {
	 ...
	 */
	function mesinhl_adjust_body_class( $classes ) {
		_deprecated_function( 'mesinhl_adjust_body_class', '0.9.4' );
		return $classes;
	}
}

if ( ! function_exists( 'mesinhl_slbd_count_widgets' ) ) {
	/**
	 ...
	 * @deprecated 0.8.9
	 */
	function mesinhl_slbd_count_widgets( $sidebar_id ) {

		_deprecated_function( 'mesinhl_slbd_count_widgets', '0.8.9', 'mesinhl_widget_classes' );
